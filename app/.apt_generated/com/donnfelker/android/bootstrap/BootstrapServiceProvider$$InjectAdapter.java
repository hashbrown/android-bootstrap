...
public final class BootstrapServiceProvider$$InjectAdapter extends Binding<BootstrapServiceProvider>
  ...
  private Binding<com.donnfelker.android.bootstrap.authenticator.ApiKeyProvider> keyProvider;
  private Binding<com.donnfelker.android.bootstrap.core.UserAgentProvider> userAgentProvider;

  public BootstrapServiceProvider$$InjectAdapter() {
    super("com.donnfelker.android.bootstrap.BootstrapServiceProvider", "members/com.donnfelker.android.bootstrap.BootstrapServiceProvider", NOT_SINGLETON, BootstrapServiceProvider.class);
  }
  ...
  public void attach(Linker linker) {
    keyProvider = (Binding<com.donnfelker.android.bootstrap.authenticator.ApiKeyProvider>) linker.requestBinding("com.donnfelker.android.bootstrap.authenticator.ApiKeyProvider", BootstrapServiceProvider.class);
    userAgentProvider = (Binding<com.donnfelker.android.bootstrap.core.UserAgentProvider>) linker.requestBinding("com.donnfelker.android.bootstrap.core.UserAgentProvider", BootstrapServiceProvider.class);
  }
